...
public class AnimatableTexture extends SimpleTexture {
    ...
    public void load(ResourceManager manager) throws IOException {
        ...
        try {
            ...
            AnimationMetadataSection metadata = resource.getMetadata(AnimationMetadataSection.SERIALIZER);
            this.animationContents = metadata == null ? null : new AnimationContents(nativeImage, metadata);
    ...
    public static void setAndUpdate(ResourceLocation texturePath) {
        setAndUpdate(texturePath, (int) getCurrentTick());
    }
    ...
    private class FrameSize {
        ...
        public FrameSize(Pair<Integer, Integer> frameSize) {
    ...
    private class AnimationContents {
        ...
        private AnimationContents(NativeImage image, AnimationMetadataSection animMeta) {
            this.frameSize = new FrameSize(animMeta.getFrameSize(image.getWidth(), image.getHeight()));
        ...
        private Texture generateAnimatedTexture(NativeImage image, AnimationMetadataSection animMeta) {
            if (!isMultipleOf(image.getWidth(), this.frameSize.width()) || !isMultipleOf(image.getHeight(), this.frameSize.height())) {
